...
function Navbar() {
  ...
  return (
    <nav
      className="w-full h-14 flex justify-between px-4 md:px-8 items-center bg-gray-100 shadow-md"
    >
      {/* Logo */}
      ...
      {isMenuOpen && (
        <div className="absolute top-14 left-0 w-full bg-gray-100 shadow-md">
